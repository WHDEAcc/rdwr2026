export const PROJECT_STATIC_DATA = [
  {
    id: '1',
    locationKey: 'Shenzhen, China',
    year: '2022-ongoing',
    scale: '42 hectares',
    categoryKey: 'Transportation Infrastructure',
  ...
  {
    id: '6',
    locationKey: 'Yantai, Shandong, China',
    year: '2021-2024',
    scale: '200,000 m²',
    categoryKey: 'Convention Centers',
  ...
  {
    id: '8',
    locationKey: 'Shekou, Shenzhen, China',
    year: '2016-2023',
    scale: '40,000 m²',
    categoryKey: 'Residential',
...
export const SERVICE_STATIC_DATA = [
  {
    id: '0',
    icon: '01',
...
export const PHILOSOPHY_STATIC_DATA = [
  { id: '0', icon: '01' },
  { id: '1', icon: '02' },
  { id: '2', icon: '03' },
  { id: '3', icon: '04' }
...
export const TESTIMONIAL_STATIC_DATA = [
  {
    id: '0',
    rating: 5,
